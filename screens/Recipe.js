    ...
    function renderHeaderBar(){
        return(
            ...
            >
                    ...
                    style={{
                        ...
                        /*transforms: [
                        {
                            translateY: scrollY.interpolate({
                                inputRange:[HEADER_HEIGHT-100,HEADER_HEIGHT-50],
                                outputRange:[HEADER_HEIGHT[50,0],
                                extrapolate:'clamp'
                            })
                        }
                    ]*/
                ...
                >
                    <Text style={{color:COLORS.lightGray2,...FONTS.body4}}>Recipe:</Text>
                    <Text style={{color:COLORS.white2,...FONTS.h3}}>{selectedRecipe?.name}</Text>
                </Animated.View>
                {/*Back Button */}
                <TouchableOpacity
                    style={{
